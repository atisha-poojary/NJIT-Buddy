...
//  Buddy_Swift
//
//  Created by Atisha Poojary on 17/05/16.
...
//        self.window = UIWindow(frame: UIScreen.mainScreen().bounds)
    ...
    lazy var applicationDocumentsDirectory: NSURL = {
        // The directory the application uses to store the Core Data store file. This code uses a directory named "NJIT.Buddy_Swift" in the application's documents Application Support directory.
    ...
    lazy var managedObjectModel: NSManagedObjectModel = {
        ...
        let modelURL = NSBundle.mainBundle().URLForResource("Buddy_Swift", withExtension: "momd")!
